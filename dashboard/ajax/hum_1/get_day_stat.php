...
// GET MIN VALUE, DATE
$query = "SELECT value, date FROM humidity_1 WHERE date BETWEEN '{$start}' AND '{$end}'";
...
// GET AVERAGE
$query = "SELECT AVG(value) AS ave FROM humidity_1 WHERE date BETWEEN '{$start}' AND '{$end}'";
$result = mysqli_query($con, $query);
